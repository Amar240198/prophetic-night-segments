...
export function TodayPage() {
  ...
  return (
    <>
      ...
      <AutomationTimeline />
      <details>
        <summary>Prayer, night and sync details</summary>
        <div className="dashboard-grid">
          ...
          <Card title="Today’s schedule">
            ...
            {routineIssues.length > 0 && (
              <p role="status">
                Timing unavailable for: {routineIssues.join(", ")}. Configure the required anchors
                in your routine settings.
              </p>
            )}
            <Link className="module-link" href="/app/prayers">
              View timetable →
          ...
          <Card title="Night">
            ...
            Temporal.Instant.from(result.night.start)
              ...
              <p>
                Calculate tonight to see Maghrib, following Fajr, the last third and final sixth.
              </p>
            )}
